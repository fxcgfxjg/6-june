...
➡️ /addsession - Save materials by logging in to your own account using the bot. To generate a session, use @SmexyStringSessionBot. Make sure you trust the source to generate the session. 
